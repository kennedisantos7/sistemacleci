    ...
    <div className="max-w-container-max mx-auto px-margin-mobile md:px-gutter py-12">
      ...
      <nav aria-label="Breadcrumb" className="font-label-md text-label-md text-on-surface-variant flex items-center gap-2 mb-8">
        ...
        {categoriaAtiva ? (
          ...
          <span className="text-on-surface" aria-current="page">Comunicação Visual</span>
        )}
      </nav>
      ...
      <div className={cn(
        ...
        <h1 className="font-headline-lg text-headline-lg text-on-surface">
          {categoriaAtiva ? categoriaAtiva : "Comunicação Visual"}
        </h1>
      ...
      <div className="flex flex-col lg:flex-row gap-gutter">
        ...
        {/* ── Sidebar ── */}
        <aside 
          aria-label="Categorias de comunicação visual" 
          className={cn(
