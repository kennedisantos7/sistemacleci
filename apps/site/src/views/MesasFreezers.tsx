...
import { MESAS_FREEZERS_CATALOG as FALLBACK_CATALOG, MESAS_FREEZERS_SLUGS as FALLBACK_SLUGS } from "../data/mesas-freezers";
            ...
            <ul className="space-y-2">
              ...
              {CATEGORIAS.map((cat) => {
                ...
                return (
                  <li key={cat}>
                    <Link
                      href={`/mesas-e-freezers?tipo=${catSlug}`}
                      onClick={() => setShowFiltersMobile(false)}
                      className={cn(
                        "flex items-center justify-between w-full text-left py-2 px-3 rounded-lg font-body-md text-body-md transition-colors",
